...
class DistanceTimeSolver(SplineNdSolver, Abstract):
    ...
    def add_acceleration_constraint(self, t: float, acceleration: float) -> bool:
    ...
    def add_acceleration_lower_bound(self, t: float, acceleration: float) -> bool:
        if hasattr(acceleration, '__len__'):
            for t_val, a_val in zip(t, acceleration):
    ...
    def add_acceleration_upper_bound(self, t: float, acceleration: float) -> bool:
        if hasattr(acceleration, '__len__'):
            for t_val, a_val in zip(t, acceleration):
