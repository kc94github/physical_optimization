...
double Polynomial1d::evaluate(const double& t) {
    return summation(std::bind(&CoefficientBase::t_coefficient, this, std::placeholders::_1), t);
}

double Polynomial1d::derivative(const double& t) {
    return summation(std::bind(&CoefficientBase::t_first_derivative_coefficient, this, std::placeholders::_1), t);
}

double Polynomial1d::second_derivative(const double& t) {
    return summation(std::bind(&CoefficientBase::t_second_derivative_coefficient, this, std::placeholders::_1), t);
}

double Polynomial1d::third_derivative(const double& t) {
    return summation(std::bind(&CoefficientBase::t_third_derivative_coefficient, this, std::placeholders::_1), t);
}
