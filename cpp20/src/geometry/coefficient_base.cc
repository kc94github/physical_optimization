...
bool CoefficientBase::updateHessianMatrix(OsqpEigen::Solver& solver,
...
std::vector<double> CoefficientBase::t_first_derivative_coefficient(double t) const{
    std::vector<double> res(_order + 1, 0);
...
std::vector<double> CoefficientBase::t_second_derivative_coefficient(double t) const{
    std::vector<double> res(_order + 1, 0);
...
std::vector<double> CoefficientBase::t_third_derivative_coefficient(double t) const{
    std::vector<double> res(_order + 1, 0);
