...
TEST(Polynomial2dTest, BasicTest) {
  ...
  Geometry::Polynomial2d a = Geometry::Polynomial2d::polynomial_from_coefficients(x_coeffs, y_coeffs);
  ...
  Geometry::Polynomial2d b = Geometry::Polynomial2d::polynomial_from_coefficients(x_coeffs, y_coeffs);
  EXPECT_EQ(a, b);
}
...
TEST(Polynomial2dTest, BasicTest2) {
  ...
  Geometry::Polynomial1d a = Geometry::Polynomial1d::polynomial_from_coefficients(x_coeffs);
  Geometry::Polynomial1d b = Geometry::Polynomial1d::polynomial_from_coefficients(y_coeffs);

  Geometry::Polynomial2d c = Geometry::Polynomial2d::polynomial_from_1d_polys(a, b);
